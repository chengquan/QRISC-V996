...
dm_sba #(.ABITS(ABITS)) u_dm (
    ...
    ,.dbg_ebreakm_o(dbg_ebreakm_o), .dbg_ebreak_i(dbg_ebreak_i), .dbg_ebreak_pc_i(dbg_ebreak_pc_i)
    ,.dbg_redirect_o(dbg_redirect_o), .dbg_redirect_pc_o(dbg_redirect_pc_o)
);
